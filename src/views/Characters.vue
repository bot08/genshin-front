<template>
  ...
  <div v-else class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
    <CharactersCard v-for="item in characters" :key="item.name" :nameProps="item.name" :nameEngProps="item.nameeng" :rarityProps="item.rarity" :icoProps="item.ico.path"/>
  </div>
...
import CharactersCard from '@/components/disposable/CharactersCard.vue'
