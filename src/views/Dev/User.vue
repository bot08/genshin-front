<template>
    ...
    <!-- Forms -->
      ...
      <button v-else @click="singin()" class="w-full py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white transition ease-in-out bg-indigo-600 hover:bg-indigo-500 dark:hover:bg-indigo-700 focus:outline-none">Войти</button>
